...
export default function DormitorioPage() {
  ...
  const bedroomProducts = useMemo(() => {
    let filtered = products.filter((p) => p.category === "dormitorio")
        ...
        <section className="py-16 px-6 bg-off-white">
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              <h1 className="text-5xl font-light tracking-tight text-charcoal mb-4">
                Dormitorio
              </h1>
              <p className="text-gray-600 text-lg font-light max-w-2xl mx-auto">
                Crea un dormitorio tranquilo y elegante con nuestra colección de camas, muebles y accesorios minimalistas
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="pt-12 pb-24 px-6 bg-white">
          <div className="max-w-7xl mx-auto">
            <div className="mt-4 mb-4">
              <Breadcrumbs currentPage="Dormitorio" />
            </div>
            <CategoryToolbar
