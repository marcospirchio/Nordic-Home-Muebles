...
export default function LivingPage() {
  ...
  const livingProducts = useMemo(() => {
    let filtered = products.filter((p) => p.category === "sala")
        ...
        <section className="py-16 px-6 bg-off-white">
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              <h1 className="text-5xl font-light tracking-tight text-charcoal mb-4">Sala</h1>
              <p className="text-gray-600 text-lg font-light max-w-2xl mx-auto">
                Transforma tu espacio con nuestros sofás, mesas y accesorios de diseño minimalista escandinavo
              </p>
            </div>
          </div>
        </section>
